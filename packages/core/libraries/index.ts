import { MK_NATIVE_FUNCTION, MK_OBJECT, type FunctionCall, type RuntimeValue } from "@core/runtime/values.ts";
import { default_libraries } from "@core/runtime/built-in/libraries.ts";
import Environment, { createGlobalEnvironment } from "@core/runtime/environments.ts";
import { evaluate } from "@core/runtime/interpreter.ts";

import Parser from "@core/frontend/parser.ts";

import { handleError, ImportError } from "@core/utils/errors_handler.ts";
